...
public class MyHttpClientSSL {
    ...
    public static CloseableHttpResponse doGet(String url, String data) {
        ...
        CloseableHttpClient httpClient = HttpClientBuilder.create().setKeepAliveStrategy(new DefaultConnectionKeepAliveStrategy())
                .setRedirectStrategy(new DefaultRedirectStrategy()).setDefaultCookieStore(cookieStore).setDefaultRequestConfig(requestConfig).build();
    ...
    public static void main(String[] args) {
        CloseableHttpResponse response = MyHttpClientSSL
                .doHttpsGet("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxb2ebe42765aad029&secret=720661590f720b1f501ab3f390f80d52", "");
        System.out.println(MyHttpClientSSL.toString(response));
    }
